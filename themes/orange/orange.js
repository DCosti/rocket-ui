import DefaultLogo from "@totalsoft_oss/rocket-ui.images.logo";
...
const palette = {
  ...
  sideMenu: {
    ...
    activeBk: "linear-gradient(60deg, #FF6F00, #f9d264)",
  ...
  button: {
    ...
    themeHoverColor: "#FF6F00",
    themeHoverShadow:
      "0 2px 2px 0 rgba(255, 111, 0, 0.42), 0 3px 1px -2px rgba(255, 111, 0, 0.12), 0 1px 5px 0 rgba(255, 111, 0, 0.2)",
    themeShadow:
      "0 2px 2px 0 rgba(255, 111, 0, 0.14), 0 3px 1px -2px rgba(255, 111, 0, 0.2), 0 1px 5px 0 rgba(255, 111, 0, 0.12)"
  }
};
